...
export default function Experience() {
  const experiences = [
    ...
    },
    {
      ...
      responsibilities: [
        "Created robust API endpoints using Express and MongoDB aggregate pipelines, improving data processing speed by 30% and reducing API response time by 25%.",
        "Enhanced communication, teamwork, and problem-solving skills by proactively addressing challenges and collaborating with team members daily, leading to a 15% increase in project delivery efficiency."
      ],
    },
  ]
