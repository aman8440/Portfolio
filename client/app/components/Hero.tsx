  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 hero-container-main">
          <motion.div
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto lg:mx-0">
              ...
              full-stack applications using MongoDB, Express.js, React, Angular, CodeIgniter and Node.js.
            </p>
