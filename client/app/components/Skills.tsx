...
import { Code, Database, Server, GitBranch, Terminal, Layers } from "lucide-react"
...
const skills = [
  {
    ...
    description:
      "Building responsive and interactive user interfaces with modern React features and Angular for optimal performance.",
    color: "text-blue-500",
  },
  {
    icon: Server,
    name: "Backend Development",
    tech: "Node.js, Express, CodeIgniter, Amplify",
